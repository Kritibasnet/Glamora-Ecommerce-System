...
export const storeProducts = [
  ...
  },
  {
    id: 6,
    title: "Treatment Oil",
    img: "/img/treatmentoil.jpg",
    price: 48,
    company: "phaedra botanicals",
    category: "Skincare",
    info:
      "Ex Prūnīs is abundant in broad-spectrum nutrients and antioxidants with astonishing effects on the skin celebrated in France for generations. It offers a unique marzipan-like signature aroma.",
    inCart: false,
    inStock: true,
    count: 0,
    total: 0
  },
  {
    ...
    category: "Accessories",
    info:
      "Professional cosmetics makeup brushes, complete Foundation, Eyeshadow Blending, Blush, Eyeliner & Face Powder.",
    inCart: false,
    inStock: true,
    count: 0,
    total: 0
  ...
  },
  {
    ...
    category: "Accessories",
    info:
      "Red Bag Synthetic material red colored sling bag Golden chain sling belt for a fashion edge ,Super fashionable sling bag to carry with the finest of your ensembles",
    inCart: false,
    inStock: true,
    count: 0,
    total: 0
  },
  {
    ...
    company: "HydraGlow",
    category: "Skincare",
    info: "Advanced hydration formula with Vitamin C and Hyaluronic acid for a radiant complexion.",
    inCart: false,
    inStock: true,
    count: 0,
    total: 0
  ...
  },
  {
    ...
    company: "LuxTime",
    category: "Accessories",
    info: "Premium limited edition timepiece with elegant leather strap and sapphire crystal.",
    inCart: false,
    inStock: false,
    count: 0,
    total: 0
  },
  {
    ...
    company: "Elle",
    category: "Accessories",
    info: "Classic suede handbag with modern gold accents. Perfect for formal occasions.",
    inCart: false,
    inStock: false,
    count: 0,
    total: 0
